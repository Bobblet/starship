 ...
 * @author Nop
 * @author Karl Hübner
 * @author Philipp Sam Szczecina
 * @author Robert Thomas Keil
 */
public class StarshipFlagEncoder extends AbstractFlagEncoder {
    static final int SLOW_SPEED = 2;
    static final int MEAN_SPEED = 4;
    static final int FERRY_SPEED = 7;
     ...
     */
    public StarshipFlagEncoder() {
        this(4, 1);
    }

    public StarshipFlagEncoder(PMap properties) {
    ...
    public StarshipFlagEncoder(String propertiesStr) {
        this(new PMap(propertiesStr));
    }

    public StarshipFlagEncoder(int speedBits, double speedFactor) {
        ...
        absoluteBarriers.add("horse_stile");
